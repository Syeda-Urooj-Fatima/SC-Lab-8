...
public class DataEntryPreparedStatement {
    ...
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            String sql = "INSERT INTO Student(Name, Registration_number, Semester, Address) VALUES(?,?,?,?)";
            stmt = conn.prepareStatement(sql);

            conn.setAutoCommit(false);

            long startTime = System.currentTimeMillis();
            DataEntryPreparedStatement dataEntry=new DataEntryPreparedStatement();
            String name="";
            String address="";
            int registration=0;
            int semester=1;
